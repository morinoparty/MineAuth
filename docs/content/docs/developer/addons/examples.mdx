...
description: Complete addon implementation examples using MineAuth API
---
...
| Method | Path | Auth |
|--------|------|------|
| GET | `/api/v1/plugins/shopaddon/shops` | No |
| GET | `/api/v1/plugins/shopaddon/shops/{id}` | No |
| GET | `/api/v1/plugins/shopaddon/users/me/shops` | Yes |
| POST | `/api/v1/plugins/shopaddon/shops` | Yes |
| PUT | `/api/v1/plugins/shopaddon/shops/{id}` | Yes |
| DELETE | `/api/v1/plugins/shopaddon/shops/{id}` | Yes |

### Stats Addon (plugin name: `statsaddon`)

| Method | Path | Auth |
|--------|------|------|
| GET | `/api/v1/plugins/statsaddon/stats/{uuid}` | No |
| GET | `/api/v1/plugins/statsaddon/stats/me` | Yes |
| GET | `/api/v1/plugins/statsaddon/leaderboard` | No |
