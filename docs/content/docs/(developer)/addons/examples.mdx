...
description: MineAuth APIを使った完全なアドオン実装例
---
...
| Method | Path | Auth |
|--------|------|------|
| GET | `/api/v1/plugins/shopaddon/shops` | ❌ |
| GET | `/api/v1/plugins/shopaddon/shops/{id}` | ❌ |
| GET | `/api/v1/plugins/shopaddon/users/me/shops` | ✅ |
| POST | `/api/v1/plugins/shopaddon/shops` | ✅ |
| PUT | `/api/v1/plugins/shopaddon/shops/{id}` | ✅ |
| DELETE | `/api/v1/plugins/shopaddon/shops/{id}` | ✅ |

### Stats Addon (plugin name: `statsaddon`)

| Method | Path | Auth |
|--------|------|------|
| GET | `/api/v1/plugins/statsaddon/stats/{uuid}` | ❌ |
| GET | `/api/v1/plugins/statsaddon/stats/me` | ✅ |
| GET | `/api/v1/plugins/statsaddon/leaderboard` | ❌ |
